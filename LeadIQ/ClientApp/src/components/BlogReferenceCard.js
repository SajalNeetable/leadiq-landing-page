...
export default class BlogReferenceCard extends Component {
    render() {
        return (
            <div key={this.props.index.index}>
                <div className="row">
                    ...
                    <div className="col-md-8 col-lg-8 blogSection mb-5">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-7 col-lg-7 mt-3 ">
                                ...
                                <label><Link to="/">continue Reading...</Link></label>
                            </div>
                        </div>
                        <div className="container">
                            <div className="leadIqIconDetails mt-5 row ml-2">
                                <div className="col-md-6 col-lg-6 ">
                                    ...
                                    <label className="">{this.props.blog.leadIqTitle}</label>
                                </div>
                                <div className="col-md-6 col-lg-6 justify-content-end d-flex iconComment">
                                    <span><i className="fa fa-comment"></i>0</span>&nbsp;&nbsp;
                                    <span><i className="fa fa-share-alt-square "></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
