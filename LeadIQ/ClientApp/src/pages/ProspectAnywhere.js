        ...
        return (
            <div className="fontDesign">
                <div className="prospectCover">
                    <div className="container prospectHeaderTitle">
                        <section className="pt-5 gettingStarted">
                            <h1 className="text-white justify-content-center d-flex mt-5 pt-5 mb-4 fa-2x prospectText"><b>Prospect Anywhere</b></h1>
                            <h4 className="text-white justify-content-center d-flex chromeText mb-4">Chrome Extension</h4>
                ...
                <div className="waveDesign">
                    <img src="/img/wave-four.png" className="img-fluied waveDesignProspect" />
                </div>
                ...
                <div>
                    <div className="row salesForceCover pt-5 pb-5">
                        <div className="col-md-5 col-lg-5">
                            <img src="/img/prospect-laptop-second.png" className="img-fluied prospectLaptopSecondDesign" />
                        </div>
                ...
                <div>
                    <div className="row emailProspectCover pt-5 pb-5">
                        <div className="col-md-5 col-lg-5">
                            <img src="/img/prospect-laptop-third.png" className="img-fluied prospectLaptopSecondDesign" />
                        </div>
                        <div className="col-md-7 col-lg-7 mt-5 pt-5">
