                        ...
                        <div className="card">
                            <div className="card-body card-blog">
                                ...
                                <QuoteCard
                                    ...
                                    author="Charles Moreton"
                                />
                                <p>Growth is exploding at Videolicious. Sales has grown triple digits and the average deal size has doubled over the last 18 months. This growth is due to the team implementing the right tech stack (LeadIQ included) that allows them to priortize sales activity.</p>
