                        ...
                        <div className="card">
                            <div className="card-body card-blog">
                              ...
                              <div className="embed-responsive embed-responsive-16by9 text-cnter">
                                    <iframe src="//play.vidyard.com/EFDbhSqiGdNeWxjRarWFXZ.html?v=3.1.1" title="video"   scrolling="no" />
                                </div>
                                ...
                                <div className="embed-responsive embed-responsive-16by9 text-cnter mt-4">
                                    <iframe src="//play.vidyard.com/JgmDgQgi5unojJneHk6o6J.html?v=3.1.1" title="video"  scrolling="no" />
                                </div>
                                ...
                                <div className="embed-responsive embed-responsive-16by9 text-cnter mt-4">
                                    <iframe src="//play.vidyard.com/MBvwrC4V9RhF2Fjub5BCiP.html?v=3.1.1" title="video"  scrolling="no" />
                                </div>
